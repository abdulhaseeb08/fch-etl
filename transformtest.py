...
rx_df["dispensed_quantity"] = rx_df["dispensed_quantity"].astype(str).str.replace(".", "", regex=False)
# %%
...
validation_conditions = [
    ...
    (rx_df["dispensed_quantity"].notna() & ~rx_df["dispensed_quantity"].astype(str).str.isdigit(), "DISPENSED_QUANTITY is not an integer"),
...
if not failed_rows.empty:
    validation_failed_df = failed_rows.drop(columns=["_dlt_load_id", "_dlt_id", "file_date"]).rename(columns={"validation_errors": "reason"})
else:
