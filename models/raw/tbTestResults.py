...
class TBTestResults(BaseModel):
    ...
    tested_by: str = Field(alias="TESTED_BY")
    ppd_tst_dt: Optional[date] = Field(alias="PPD_TST_DT", default=None)
    ppd_tst_read_dt: Optional[date] = Field(alias="PPD_TST_READ_DT", default=None)
    ...
    next_tst_dt: Optional[date] = Field(alias="NEXT_TST_DT", default=None)
